...
public class ShareService {
	...
	private ShareEntity convertToEntity(ShareDTO dto) {
		...
		return ShareEntity.builder().shareId(dto.getShareId()).host(host)
				...
				.town(new TownEntity(dto.getTownId().intValue(), null, null)).postalCode(dto.getPostalCode())
				.title(dto.getTitle()).description(dto.getDescription()).maxGuests(dto.getMaxGuests())
				.currentGuests(dto.getCurrentGuests()).price(dto.getPrice() == null ? BigDecimal.ZERO : dto.getPrice())
				.address(dto.getAddress()).detailAddress(dto.getDetailAddress()).createdAt(dto.getCreatedAt())
